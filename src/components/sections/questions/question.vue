<template>
    <tr v-if="dell">
      ...
      <td>ما هي عاصمه اسرائيل</td>
      <td class="open">
       50
      </td>
      <td class="open">لا توجد </td>
      <td class="open"> مش عارف يعني اي تفسير اصلا </td>
      <td class="open">اختيار واحد</td>
      <td class="open">      <a
          class="show"
          @click="
            this.redirectTo({
    ...
    <tr class="close" v-if="!opened">
      <td colspan="7">
        ...
        <i class="fa-solid fa-circle-xmark exam" v-else></i>
          ...
          <li>الصوره ( ان وجدت )<div>{{ cours.academic_year }} </div>
          </li>
          <li>التفسير<div>{{ cours.academic_year}} </div>
          </li>
          <li>النوع<div>متعدد الاختيارات</div>
          </li>
