                    ...
                    <div class="ttl121">
                      <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item">
                            <router-link :to="{name : 'home'}">منهج الفيزياء للثانويه العامه </router-link>
                          </li>
                          <li class="breadcrumb-item active" aria-current="page">
                            نتيجه اختبار الوحده الاولي 
                          </li>
                        </ol>
                      </nav>
                    </div>
								...
								<a href="certification_center.html" class="blog_link"> الرجوع للدورة <i class="fa-solid fa-angles-left"></i></a>
							</div>
                </div>
                <div class="title126">
                  <img
