        ...
        <div class="backgrund">
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
              <div class="row text">
                <div class="col-12">
                  <h2>منهج الفيزياء الثانوية العامة</h2>
                </div>
                <div class="row">
                  <div class="col-12">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="sub">
                      <i class="fa fa-users "></i> 150 مشترك
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-4">
                    <div class="time">
                      <i class="fa-regular fa-clock border"></i>
                      معاد الدورة : السبت الساعة 5 مساءا
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="time"> 
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="quest-tab" data-bs-toggle="tab" data-bs-target="#quest" type="button" role="tab"
              ...
              <i class="fa-solid fa-question"></i> الاسئلة
            </button>
          </li>
          <li class="nav-item" role="presentation">
