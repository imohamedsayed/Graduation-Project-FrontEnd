<template>
  <div class="login-user-page">
    ...
    <div class="login-form">
      ...
      <p class="text-center">هذه الصفحة خاصة فقط بالمسؤلين عن ادارة الموقع</p>
...
.login-user-page {
  ...
  top: 0;
  left: 0;
  background: url("../../../public/images/landing/—Pngtree—flat\ business\ login\ box\ login_1319176.jpg") top center;
