            ...
            <div class="row">
              <div class="col-lg-6">
                <h2 class="st_title cr_course_title">
                  <i class="fas fa-plus-circle"></i> اضافه اختيارات للسوال المتعدد
                </h2>
                                  ...
                                  <div class="ui search focus mt-30 lbel25">
                                    ...
                                    <label class="radio-button">
                                      <input
                                        value="3"
                                        type="checkbox"
                                        v-model="state.three_is_correct"
                                      />
                                      <span class="radio"></span>
                                    </label>
                                  </div>
