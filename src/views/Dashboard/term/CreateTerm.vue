                      ...
                      <div class="col-lg-6 col-md-6">
                        <div class="ui mt-30 focus box search">
                          ...
                          <select v-model="firstvalue">
                            ...
                            <option value="one" selected>الاول الثانوي </option>
                            <option value="two">الثاني الثانوي</option>
                            <option value="three">الثالث الثانوي</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6">
                        <div class="ui mt-30 focus box search">
                          ...
                          <select v-model="secondvalue">
                            ...
                            <option value="first" selected>الترم الدراسي الاول</option>
                            <option value="second">الترم الدراسي الثاني</option>
                          </select>
                        </div>
                      </div>
                            </div>
