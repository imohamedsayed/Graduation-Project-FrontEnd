        ...
        <div class="col-12">
          <div class="form">
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12">
                  <div class="ui mt-30 focus box search">
                    <label > <i class="fas fa-pencil-alt "></i>عنوان الدورة</label>
                    <input type="text" name="" id="">
                  </div>
                </div>
                <div class="col-lg-12 col-md-12">
                  <div class="course_des mt-30 box ">
                    <label > <i class="far  fa-sticky-note "></i> وصف الدورة </label>
                    <textarea  id="" placeholder="اكتب وصف المحتوي..."></textarea>
                  </div>
                </div>
                <div class="col-lg-12 col-md-12">
                  <div class="mt-30 box">
                    <label > <i class="fas fa-list "></i> القسم الرئيسي </label>
                ...
                <div class="col-lg-12 col-md-12">
                  <div class="box">
                    <label > <i class="fas fa-list "></i>المرحلة الدراسية </label>
                    <select class="ui hj145 cntry152">
                      <option selected disabled value="">اختيار من القائمة</option>
            ...
            <div class="view_info">
              <div class="left">
                <div class="view_img">
                  <img src="../../public/images/courses/add_img.jpg" alt="">
                </div>
              </div>
              <div class="right">
                <h4>صورة الغلاف</h4>
                <p>قم بتحميل صورة الدورة التدريبية الخاصة 
                  بك هنا. يجب أن تفي بمعايير جودة صورة الدورة التدريبية لدي
                  نا حتى يتم قبولها. إرشادات مهمة: 750 × 420 بكسل ؛ .jpg ،
                  .jpeg ،. gif أو png.
                </p>
